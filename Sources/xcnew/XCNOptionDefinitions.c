/**
 * This file is generated from Sources/xcnew/xcnew.mxml with the following command.
 *
 *     ./Scripts/xml2c -p XCN Sources/xcnew/xcnew.mxml Sources/xcnew/XCNOptionDefinitions.c
 *
