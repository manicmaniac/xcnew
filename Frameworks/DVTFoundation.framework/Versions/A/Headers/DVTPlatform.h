...
+ (BOOL)loadAllPlatformsReturningError:(NSError *__unsafe_unretained _Nullable *)error;
+ (void)_loadPlatformAtPath:(id)arg1;
+ (id)_propertyDictionaryForPlatformAtPath:(id)arg1;
+ (nonnull NSArray<DVTPlatform *> *)allPlatforms;
...
+ (id)platformForIdentifier:(NSString *_Nonnull)identifier;
